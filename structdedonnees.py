list_id= ["bWABWA","ilunga",19]
print(list_id)#l affichage de la liste id 
print(list_id[0])#l affichage de la  premiere lettre
print (list_id[1]) #l affichage de la deuxieme lettre 
#le dictionnaire  de villes de la province du haut katanga
dic_ville={"hk":["lubumbashi","likasi","kasumbalesa"]} 
